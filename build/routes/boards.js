...
router.put('/:id', $.getItem('board'), $.validateAccess('admin', 'allowPassage'), $.updateUserAdmin('board'), board.updateLabel, $.updateItem('board', 'omit:users:project_id'), $.saveItem('board'), $.respond());
